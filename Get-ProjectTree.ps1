function Get-ProjectTree {
    param (
        ...
        [string[]]$Exclude = @("node_modules", "dist", "build", "coverage", "out", ".git", ".vscode", ".idea", "logs", "hooks", "scripts", "test", "tests", "__tests__", "__mocks__", "__fixtures__", "artifacts", "public", "src/assets", "src/components", "src/pages", "src/utils", "src/styles", "src/hooks", "src/services", "src/config", "coverage", "src/tests", "src/__tests__", "src/__mocks__", "src/__fixtures__", "bin", "obj", "vendor", "temp", "tmp", "cache", "docs", "examples", "test", "typechain-types")
    )
